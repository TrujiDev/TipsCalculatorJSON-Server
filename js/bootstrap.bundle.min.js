...
!(function (t, e) {
		...
		const d = k(r, e.replace(v, '')),
			u = o
				...
				: (function (t, e) {
						return function i(n) {
							return (
								(n.delegateTarget = t), i.oneOff && P.off(t, n.type, e), e.apply(t, [n])
							);
						};
				  })(t, i);
				...
				var n =
						'clippingParents' === e
							? (function (t) {
									var e = Yt(Ot(t)),
										i =
											['absolute', 'fixed'].indexOf(Et(t).position) >= 0 && pt(t)
												? kt(t)
												: t;
									return ft(i)
										? e.filter(function (t) {
	...
	function te(t, e) {
		...
		var f = u.reduce(function (e, i) {
			return (
				(e[i] = Jt(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[
					_t(i)
				]),
				e
			);
